...
> **Nota:** restaurado al repo el 2026-07-10 desde el original de `Freelancer - Claude Active\PrestaControl\` (el nombre provisional "PrestaControl" fue reemplazado: el definitivo es **FAControl**).
